...
//level7
    for (int i = 0; i < 8; i++)
    {
        for (int j = 0; j < 2; j++)
        {
            ...
            zetas_exp[k++] = (ntt_tree[7][96*i + j + 0] * QINV) & 0xffff;
            zetas_exp[k++] = (ntt_tree[7][96*i + j + 0] * QINV) & 0xffff;
            zetas_exp[k++] = (ntt_tree[7][96*i + j + 12] * QINV) & 0xffff;
            zetas_exp[k++] = (ntt_tree[7][96*i + j + 12] * QINV) & 0xffff;
            zetas_exp[k++] = (ntt_tree[7][96*i + j + 24] * QINV) & 0xffff;
            zetas_exp[k++] = (ntt_tree[7][96*i + j + 24] * QINV) & 0xffff;
            zetas_exp[k++] = (ntt_tree[7][96*i + j + 36] * QINV) & 0xffff;
            zetas_exp[k++] = (ntt_tree[7][96*i + j + 36] * QINV) & 0xffff;
            zetas_exp[k++] = (ntt_tree[7][96*i + j + 48] * QINV) & 0xffff;
            zetas_exp[k++] = (ntt_tree[7][96*i + j + 48] * QINV) & 0xffff;
            zetas_exp[k++] = (ntt_tree[7][96*i + j + 60] * QINV) & 0xffff;
            zetas_exp[k++] = (ntt_tree[7][96*i + j + 60] * QINV) & 0xffff;
            zetas_exp[k++] = (ntt_tree[7][96*i + j + 72] * QINV) & 0xffff;
            zetas_exp[k++] = (ntt_tree[7][96*i + j + 72] * QINV) & 0xffff;
            zetas_exp[k++] = (ntt_tree[7][96*i + j + 84] * QINV) & 0xffff;
            zetas_exp[k++] = (ntt_tree[7][96*i + j + 84] * QINV) & 0xffff;

            zetas_exp[k++] = ntt_tree[7][96*i + j + 0];
            zetas_exp[k++] = ntt_tree[7][96*i + j + 0];
            zetas_exp[k++] = ntt_tree[7][96*i + j + 12];
            zetas_exp[k++] = ntt_tree[7][96*i + j + 12];
            zetas_exp[k++] = ntt_tree[7][96*i + j + 24];
            zetas_exp[k++] = ntt_tree[7][96*i + j + 24];
            zetas_exp[k++] = ntt_tree[7][96*i + j + 36];
            zetas_exp[k++] = ntt_tree[7][96*i + j + 36];
            zetas_exp[k++] = ntt_tree[7][96*i + j + 48];
            zetas_exp[k++] = ntt_tree[7][96*i + j + 48];
            zetas_exp[k++] = ntt_tree[7][96*i + j + 60];
            zetas_exp[k++] = ntt_tree[7][96*i + j + 60];
            zetas_exp[k++] = ntt_tree[7][96*i + j + 72];
            zetas_exp[k++] = ntt_tree[7][96*i + j + 72];
            zetas_exp[k++] = ntt_tree[7][96*i + j + 84];
            zetas_exp[k++] = ntt_tree[7][96*i + j + 84];
        }
        for (int j = 0; j < 2; j++)
        {
            //alpha, alpha^2, beta, beta^2, gamma, gamma^2
            zetas_exp[k++] = (ntt_tree[7][96*i + j + 6] * QINV) & 0xffff;
            zetas_exp[k++] = (ntt_tree[7][96*i + j + 6] * QINV) & 0xffff;
            zetas_exp[k++] = (ntt_tree[7][96*i + j + 18] * QINV) & 0xffff;
            zetas_exp[k++] = (ntt_tree[7][96*i + j + 18] * QINV) & 0xffff;
            zetas_exp[k++] = (ntt_tree[7][96*i + j + 30] * QINV) & 0xffff;
            zetas_exp[k++] = (ntt_tree[7][96*i + j + 30] * QINV) & 0xffff;
            zetas_exp[k++] = (ntt_tree[7][96*i + j + 42] * QINV) & 0xffff;
            zetas_exp[k++] = (ntt_tree[7][96*i + j + 42] * QINV) & 0xffff;
            zetas_exp[k++] = (ntt_tree[7][96*i + j + 54] * QINV) & 0xffff;
            zetas_exp[k++] = (ntt_tree[7][96*i + j + 54] * QINV) & 0xffff;
            zetas_exp[k++] = (ntt_tree[7][96*i + j + 66] * QINV) & 0xffff;
            zetas_exp[k++] = (ntt_tree[7][96*i + j + 66] * QINV) & 0xffff;
            zetas_exp[k++] = (ntt_tree[7][96*i + j + 78] * QINV) & 0xffff;
            zetas_exp[k++] = (ntt_tree[7][96*i + j + 78] * QINV) & 0xffff;
            zetas_exp[k++] = (ntt_tree[7][96*i + j + 90] * QINV) & 0xffff;
            zetas_exp[k++] = (ntt_tree[7][96*i + j + 90] * QINV) & 0xffff;

            zetas_exp[k++] = ntt_tree[7][96*i + j + 6];
            zetas_exp[k++] = ntt_tree[7][96*i + j + 6];
            zetas_exp[k++] = ntt_tree[7][96*i + j + 18];
            zetas_exp[k++] = ntt_tree[7][96*i + j + 18];
            zetas_exp[k++] = ntt_tree[7][96*i + j + 30];
            zetas_exp[k++] = ntt_tree[7][96*i + j + 30];
            zetas_exp[k++] = ntt_tree[7][96*i + j + 42];
            zetas_exp[k++] = ntt_tree[7][96*i + j + 42];
            zetas_exp[k++] = ntt_tree[7][96*i + j + 54];
            zetas_exp[k++] = ntt_tree[7][96*i + j + 54];
            zetas_exp[k++] = ntt_tree[7][96*i + j + 66];
            zetas_exp[k++] = ntt_tree[7][96*i + j + 66];
            zetas_exp[k++] = ntt_tree[7][96*i + j + 78];
            zetas_exp[k++] = ntt_tree[7][96*i + j + 78];
            zetas_exp[k++] = ntt_tree[7][96*i + j + 90];
            zetas_exp[k++] = ntt_tree[7][96*i + j + 90];
        }        
    }
