...
_looptop_j_0:
#load
vmovdqa		1152(%rsi),%ymm4
vmovdqa		1184(%rsi),%ymm5
vmovdqa		1216(%rsi),%ymm6
vmovdqa		1248(%rsi),%ymm7
vmovdqa		1280(%rsi),%ymm8
vmovdqa		1312(%rsi),%ymm9
...
vpsubw		%ymm10,%ymm4,%ymm10
vpaddw		1152(%rsi),%ymm10,%ymm10
vpaddw		%ymm11,%ymm5,%ymm4
vpsubw		%ymm11,%ymm5,%ymm11
vpaddw		1184(%rsi),%ymm11,%ymm11
vpaddw		%ymm12,%ymm6,%ymm5
vpsubw		%ymm12,%ymm6,%ymm12
vpaddw		1216(%rsi),%ymm12,%ymm12
vpaddw		%ymm13,%ymm7,%ymm6
vpsubw		%ymm13,%ymm7,%ymm13
vpaddw		1248(%rsi),%ymm13,%ymm13
vpaddw		%ymm14,%ymm8,%ymm7
vpsubw		%ymm14,%ymm8,%ymm14
vpaddw		1280(%rsi),%ymm14,%ymm14
vpaddw		%ymm15,%ymm9,%ymm8
vpsubw		%ymm15,%ymm9,%ymm15
vpaddw		1312(%rsi),%ymm15,%ymm15
...
vmovdqa		%ymm10,1152(%rdi)
vmovdqa		%ymm11,1184(%rdi)
vmovdqa		%ymm12,1216(%rdi)
vmovdqa		%ymm13,1248(%rdi)
vmovdqa		%ymm14,1280(%rdi)
vmovdqa		%ymm15,1312(%rdi)
...
#zetas
vpbroadcastd    (%rdx,%rax),%ymm15 #zetaqinv
vpbroadcastd    4(%rdx,%rax),%ymm2 #zeta
...
#level7
#zetas
vmovdqu    3776(%rdx,%rax),%ymm15 #ainv
vmovdqu    3808(%rdx,%rax),%ymm2 #ainv
