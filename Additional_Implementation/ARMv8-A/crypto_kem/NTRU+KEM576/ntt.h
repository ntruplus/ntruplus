...
void ntt(int16_t r[NTRUPLUS_N], const int16_t a[NTRUPLUS_N], const int16_t* zetas);
void invntt(int16_t r[NTRUPLUS_N], const int16_t a[NTRUPLUS_N], const int16_t* zetas);
