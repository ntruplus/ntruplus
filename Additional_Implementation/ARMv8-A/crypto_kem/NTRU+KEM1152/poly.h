...
void poly_shuffle(poly *r, const poly *a);
void poly_basemul2(poly *r, const poly *a, const poly *b);
int  poly_sotp_inv2(unsigned char *msg, const poly *e, const unsigned char *buf);
void poly_ntt2(poly *r, const poly *a);
void poly_invntt2(poly *r, const poly *a);
#endif
