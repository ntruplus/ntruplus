...
.p2align 5
_looptop:
vmovdqu		1864(%rcx),%ymm14#zqinv
vmovdqu		1896(%rcx),%ymm1 #z
...
vpmulhw		%ymm5,%ymm4,%ymm8  #a0 b0
vpmulhw		%ymm7,%ymm6,%ymm9  #a1 b1
vpmulhw		%ymm9,%ymm8,%ymm10  #(a0+a1)(b0+b1)

#reduce
vpmulhw		%ymm0,%ymm11,%ymm11  #a0 b0
vpmulhw		%ymm0,%ymm12,%ymm12  #a1 b1
vpmulhw		%ymm0,%ymm13,%ymm13  #(a0+a1)(b0+b1)
vpsubw		%ymm11,%ymm8,%ymm11 #a0 b0
vpsubw		%ymm12,%ymm9,%ymm12 #a1 b1
vpsubw		%ymm13,%ymm10,%ymm13 #(a0+a1)(b0+b1)
